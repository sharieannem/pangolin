...
<div class="ui green inverted raised segment">
  <div class="title">
    <h2 id="header">ARE YOU SURE THIS IS A DRILL?</h2>
  </div> <!-- div -->
</div> <!-- segment -->
  ...
  <div class="ui grid">
    ...
    $db = 'gviloria_ALERT';
      ...
      <div class="field" style="padding-top: 2em;padding-bottom: 2em;">
        <div class="ui radio checkbox">
          <input type="radio" value=0 name="confirm">
          <label>NO</label>
        </div>
      </div>
...
function redirectB() {
    var id = "<?php echo $id ?>";
    var link = "?id=";
    location.href = "greenalert.php" + link + id;
}
function redirectC() {
    var v=document.getElementsByName ("confirm")
    if (v[0].checked){
    	location.href = "green_send.php?id=<?php echo $id?>";
    } else {
